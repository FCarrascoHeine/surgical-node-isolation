...
def _result_summary(row):
    return {
        ...
        "mip_gap_tolerance": row["mip_gap_tolerance"],
        "mip_gap_abs_tolerance": row["mip_gap_abs_tolerance"],
        "feasibility_tolerance": row["feasibility_tolerance"],
        "integrality_tolerance": row["integrality_tolerance"],
